...
fun main() {
    ...
    // ---- 2. StepParser: saare types (verify_submit v24 C15; set_desktop + research v31) ----
    val types = listOf(
        ...
        "verify_submit", "set_desktop", "research"
    )
    check("type count = 19 (17 + set_desktop + research)", StepParser.TYPES.size == 19)
    for (t in types) {
